...
#else
GxEPD2_DISPLAY_CLASS<GxEPD2_DRIVER_CLASS, MAX_HEIGHT(GxEPD2_DRIVER_CLASS)> display1(GxEPD2_DRIVER_CLASS(/*CS=5*/ PIN_EPD1_CS, /*DC=*/ PIN_EPD_DC, /*RST=*/ PIN_EPD1_RST, /*BUSY=*/ PIN_EPD1_BUSY)); // my suggested wiring and proto board
GxEPD2_DISPLAY_CLASS<GxEPD2_DRIVER_CLASS, MAX_HEIGHT(GxEPD2_DRIVER_CLASS)> display2(GxEPD2_DRIVER_CLASS(/*CS=5*/ PIN_EPD2_CS, /*DC=*/ PIN_EPD_DC, /*RST=*/ PIN_EPD2_RST, /*BUSY=*/ PIN_EPD2_BUSY));
GxEPD2_DISPLAY_CLASS<GxEPD2_DRIVER_CLASS, MAX_HEIGHT(GxEPD2_DRIVER_CLASS)> display3(GxEPD2_DRIVER_CLASS(/*CS=5*/ PIN_EPD3_CS, /*DC=*/ PIN_EPD_DC, /*RST=*/ PIN_EPD3_RST, /*BUSY=*/ PIN_EPD3_BUSY));
GxEPD2_DISPLAY_CLASS<GxEPD2_DRIVER_CLASS, MAX_HEIGHT(GxEPD2_DRIVER_CLASS)> display4(GxEPD2_DRIVER_CLASS(/*CS=5*/ PIN_EPD4_CS, /*DC=*/ PIN_EPD_DC, /*RST=*/ PIN_EPD4_RST, /*BUSY=*/ PIN_EPD4_BUSY));
